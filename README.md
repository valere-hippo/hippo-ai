...
- If you want image understanding in chat, set `HIPPO_VISION_MODEL` to a vision-capable vLLM model name. If it is empty, Hippo falls back to the normal chat model plus local OCR text.
